...
public class CalificacionController {
    ...
    public ResponseEntity<List<CalificacionResponseDTO>> obtenerPorPartido(
            @PathVariable @Positive(message = "El ID debe ser un número positivo") @NonNull Long partidoId) {
        List<CalificacionResponseDTO> calificaciones = calificacionService.obtenerPorPartido(partidoId);
